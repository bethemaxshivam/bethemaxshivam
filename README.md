...
<head>
  ...
  <title>Shivam Yadav - Portfolio</title>
  ...
  <style>
    * {
    ...
    .welcome-screen {
      ...
      width: 100%;
      height: 100vh;
      background: radial-gradient(circle, #0b132b, #000);
      color: #FFD700;
      display: flex;
    ...
    .welcome-text {
      ...
      text-shadow: 0 0 10px #ffc107, 0 0 30px #ffeb3b;
    }
...
<!--
**bethemaxshivam/bethemaxshivam** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
